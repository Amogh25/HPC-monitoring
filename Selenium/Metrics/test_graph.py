...
class TestGraph():
  ...
  def json_fetch(self):
    directory = "/home/sasha/projects/Selenium"
  ...
  def test_fetchpaneldata(self,url2):
    ...
    self.driver.execute_script("window.scrollTo(0,0)")
    time.sleep(3)
    element = self.driver.find_element(By.XPATH, "/html/body/div[2]/div/div[2]/div/div/div[2]/div/div[1]/div/div/div[1]/div/div/div[2]/div/div/div[1]/div/div[2]/div/div/div[1]/div[2]")
    self.driver.execute_script("window.scrollTo(0,0)")
    time.sleep(3)
